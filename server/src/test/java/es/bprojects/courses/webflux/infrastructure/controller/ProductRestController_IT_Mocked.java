 ...
 * @since 2021-08-06
 */
// Server is not really started
@AutoConfigureWebTestClient
@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.MOCK)
class ProductRestController_IT_Mocked {

	@Value("${config.controller.endpoints}")
	String baseUrl;
	...
	public void create() {
		...
		response
				...
				.jsonPath("$.product.name").isEqualTo("NEW PRODUCT")
				.jsonPath("$.product.category").isEqualTo(category.getId());
	}
